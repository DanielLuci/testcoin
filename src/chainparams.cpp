...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0xf6f8e52847140e50339c44af2811357ca9bab3fef438c2882bc345e822204658"));
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1515510596, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
     //   printf("block.nTime = %u \n", genesis.nTime);
      //  printf("block.nNonce = %u \n", genesis.nNonce);
      //  printf("block.GetHash = %s\n", genesis.GetHash().ToString().c_str());        
